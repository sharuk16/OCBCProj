...
CREATE TABLE BankUser (
	...
	ChatID int NULL,
	DailySpend smallmoney DEFAULT 0,
...
/*****  Create records in BankUser Table *****/
insert into BankUser (NRIC, Email, Phone, Name, TransLimit, Password,ChatID) 
values ('T1234567A', 'abc@mail.com', '98765432','Lim Seng Benny',5000, 'limsngbnny32',1189363296)
...
/*****  Create records in BankAccount Table *****/
